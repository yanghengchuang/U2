     ...
     <!-- 登陆框 -->
      <div class="popup_text_area">
        <div class="popup_txt_box popup_txt_box_username">
         ...
         <input  type="text" id="PopupUserName" name="username" class="popup_txt_ipt"  placeholder="用户名/手机/邮箱">
        </div>
       </div>
       <!-- 密码框 -->
       <div class="popup_text_area1">
         ...
         <input name="password" type="password" id="PopupPassword" class="popup_pwd_ipt"  placeholder="请输入密码">
